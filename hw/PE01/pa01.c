...
void test_00_arraySum()
{
    ...
    // ...
	int array3[] = { -6, -13, 10, 11, -35, 1, 21, 32, 51 };
    int len3 = 9;
    int expected3 = 72;
    test_arraySum(array3, len3, expected3);

	// Array that results in a negative expected value
	int array4[] = { -31, -11, 0, 16, -9, -10, 27 };
    int len4 = 7;
    int expected4 = -18;
...
{
    printArray(array, len);
    int status = arrayIsIncreasing(array, len);
    printf(". status = %d, expected = %d.", status, expected);
    if(status != expected)
		printf(" FAIL");
    printf("\n");
}
...
void test_02_arrayIsIncreasing()
{
	...
	// Regular increasing array
	int array1[] = { 0, 1, 1, 2, 3, 5 };
	int len1 = 6;
	test_arrayIsIncreasing(array1, len1, 1);
	
	// Empty array should make the function return 1
	int array2[] = {};
	int len2 = 0;
	test_arrayIsIncreasing(array2, len2, 1);	
	
	// Non increasing arrays
	int array3[] = { 3, 5, 5, 4, 6, 11, 9 };
	int len3 = 7;
	test_arrayIsIncreasing(array3, len3, 0);
	
		
	int array4[] = { -1, 1, 0, 3, -4, 17 };
	int len4 = 6;
...
void test_03_arrayFindSmallest()
{
	...
	// Empty array should make the function return 1
	int array2[] = { -3, -11, 0, 4, 5, 9, 12 };
	int len2 = 7;
	test_arrayFindSmallest(array2, len2, 1);	
	
	// Non increasing arrays
	int array3[] = { 13, 5, 5, 14, 6, 11, 9 };
	int len3 = 7;
	test_arrayFindSmallest(array3, len3, 1);
		
	int array4[] = { -1, 1, 0, 17, -4, -4 };
	int len4 = 6;
...
int main(int argc, char * * argv)
{
	...
	if (atoi(argv[1]) == 0) return_value = arraySum(array, len);
	else if (atoi(argv[1]) == 1) return_value = arrayCountNegative(array, len);
	else if (atoi(argv[1]) == 2) return_value = arrayIsIncreasing(array, len);
	else if (atoi(argv[1]) == 3) return_value = arrayFindSmallest(array, len);
